# This is simple prediction of house prices based on house size, implemented in TenserFlow.
...
# generation of house sizes between 1000 and 3500 sqft of houses
...
# define number of training samples, 0.7 = 70%. We can take first 70% since the values are randomized
...
# Define operations for the predicting values, use tensorflow add and multiply
# tensorflow methods understand how to deal with
